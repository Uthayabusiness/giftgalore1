...
export function getSession() {
  ...
  // Use memory store for development if no MongoDB URI is provided
...
export async function setupAuth(app: Express) {
  ...
  // Only setup Replit auth if in production or if REPLIT_DOMAINS is provided
  let config: any = null;
  if (process.env.REPLIT_DOMAINS) {
    ...
    app.get("/api/login", (req, res) => {
      ...
      req.login(mockUser, (err) => {
        ...
        res.json({ message: 'Logged in as dev user' });
      });
    });
  }
